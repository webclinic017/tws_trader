...
def main(company, bar_size):
	...
	ax2 = draw_scatter(make_scatters('stop_loss', all_strategies), 2, fig)
	ax3 = draw_scatter(make_scatters('take_profit', all_strategies), 3, fig)
	...
	ax4 = draw_scatter(make_scatters('Stoch_period', all_strategies), 4, fig)
	ax5 = draw_scatter(make_scatters('Stoch_slow_D', all_strategies), 5, fig)
	ax6 = draw_scatter(make_scatters('Stoch_fast_K', all_strategies), 6, fig)
	ax7 = draw_scatter(make_scatters('Weekday_buy', all_strategies), 7, fig)
	ax8 = draw_scatter(make_scatters('Weekday_sell', all_strategies), 8, fig)
	ax9 = draw_scatter(make_scatters('Volume_profile_locator', all_strategies), 9, fig)
	ax10 = draw_scatter(make_scatters('SMA_period', all_strategies), 10, fig)
	plt.show()
