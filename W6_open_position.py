...
def place_bracket_order(conn, company, action, stop_loss, take_profit, quantity, order_id):
...
def close_position(conn, company, order_id):
	open_positions = []
...
if __name__ == "__main__":
	...
	company = 'TSLA'
	order_id = 80
	# place_bracket_order(c, company, 'BUY', order_id)
	close_position(c, company, order_id)
	c.disconnect()
